            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="lg">Writter </th>
                        <th data-breakpoints="lg">Publisher </th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @foreach ($publishers = explode(',', $product->publisher_id) as $publisher_id) 
                                    {{trim(publisherName($publisher_id),',')}}
                                    @if (next($publishers))
                                        {{','}}
                                    @endif
                            @endforeach
                        ...
                        <td>
                            ...
                            @foreach ($subjecs = explode(',', $product->subject_id) as $subject_id) 
                                    {{trim(subjectName($subject_id),',')}}
                                    @if (next($subjecs))
                                        {{','}}
                                    @endif
                            @endforeach
