                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import','product_bulk_export','view_product_categories', 'view_all_brands','view_product_attributes','view_colors','view_product_reviews'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                             <li class="aiz-side-nav-item">
                                <a href="{{route('admin.writer')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Writer') }}</span>
                                </a>
                            </li>
                             <li class="aiz-side-nav-item">
                                <a href="{{route('admin.publisher')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Publisher') }}</span>
                                </a>
                            </li>
                             <li class="aiz-side-nav-item">
                                <a href="{{route('admin.subject')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Subject') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
