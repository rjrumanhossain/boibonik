...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        // //Extra code in publisher, writer and subject

        Route::prefix('writer')->group(function(){
            Route::get('/', [ WriterController::class,'index' ])->name("admin.writer");
            Route::get('/store', [ WriterController::class,'added' ])->name("writter.added");
            Route::post('/store', [ WriterController::class,'store'])->name("write.store");
            Route::get('/edit/{id}', [ WriterController::class,'edit' ])->name("writter.edit");
            Route::post('/update', [ WriterController::class,'update'])->name("write.update");
            Route::get('/delete/{id}', [ WriterController::class,'destroy' ])->name("writter.destroy");

        });

        Route::prefix('publisher')->group(function(){
            Route::get('/', [ PublisherController::class,'index' ])->name("admin.publisher");
            Route::get('/store', [ PublisherController::class,'added' ])->name("publisher.added");
            ...
            Route::post('/update', [ PublisherController::class,'update'])->name("publisher.update");
            Route::get('/delete/{id}', [ PublisherController::class,'destroy' ])->name("publisher.destroy");

        });

        Route::prefix('subject')->group(function(){
            Route::get('/', [ SubjectController::class,'index' ])->name("admin.subject");
            Route::get('/store', [ SubjectController::class,'added' ])->name("subject.added");
