...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.product.products.create', compact('categories', 'publisher', 'writter','subject'));
    }
    ...
    {
        //dd(json_encode($request->subject_id));
        $product = $this->productService->store($request->except([
            '_token', 'sku', 'choice', 'tax_id', 'tax', 'tax_type', 'flash_deal_id', 'flash_discount', 'flash_discount_type'
        ]));
        $request->merge(['product_id' => $product->id]);

        //publisher, writter and Subject Added
        ...
        $this->productStockService->store($request->only([
            'colors_active', 'colors', 'choice_no', 'unit_price', 'sku', 'current_stock'
        ]), $product);
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'publisher', 'writter','subject'));
    }
